...
CKPT_ARGS=(
   ...
   --save /root/slime_siqi/output/Qwen3-1.7B_opsd_hidden_think_openthoughts/
   --save-interval 2000
)
...
GRPO_ARGS=(
  ...
  --opsd-kl-ppo-tau 0.6 \    # τ (entropy gate threshold)  
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-1.7B-opsd_hidden_think-kl_biased_ppo-openthoughts-kl05-nothinking
...
unset RAY_ADDRESS
ray stop --force || true
export CUDA_VISIBLE_DEVICES=1,3,5,6,7,8
...
ray job submit --address="http://127.0.0.1:8265" \
   --runtime-env-json='{
     "env_vars": {
        ...
        "CUDA_VISIBLE_DEVICES": "1,3,5,6,7,8"
     }
   }' \
   -- python3 train.py \
   --actor-num-nodes 1 \
