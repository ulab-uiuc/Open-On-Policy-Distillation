...
CKPT_ARGS=(
   ...
   --save /root/slime_siqi/output/Qwen3-1.7B_opsd_answeronly_reasoning_dapo/
   --save-interval 2000
)
...
ROLLOUT_ARGS=(
   ...
   --label-key label
   --apply-chat-template
   --apply-chat-template-kwargs '{"enable_thinking":false}'   # 这里 enable_thinking=True 是为了让 teacher 侧能正确生成 <think> 块
   --rollout-shuffle
   --num-rollout 300
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-1.7B-opsd_answeronly-reasoning-topk_tail_kl_dapo
